    ...
    template(model) {
        ...
        <form class="notas-form">
            <div class="campo-nota1 form-group">
                ...
                <input id="peso1" class="peso form-control" type="number" value="4" disabled>
            ...
            <div class="campo-nota2">
                ...
                <input id="peso2" class="peso form-control" type="number" value="6" disabled>

                <label for="nota2">Nota</label>
                <input id="nota2" class="nota form-control" type="number">
            </div>
            <div class="bnt-calcula-nota">
                <button class="btn" onclick="notasController.calculaNota()">Calcular</button>
            </div>                
        </form>
        `;
    }
