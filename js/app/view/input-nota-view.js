    ...
    template(model) {
        ...
        <form class="notas-form" onsubmit="notasController.calculaNota(event)">
            <div class="campo-nota1 form-group">
                ...
                <input id="nota1" class="nota form-control" type="number" step="0.1" min="0" max="10" required>
            </div>
            <div class="campo-nota2">
                ...
                <input id="nota2" class="nota form-control" type="number" step="0.1" min="0" max="10" required>
            </div>
