        ...
        return `
            <form class="notas-form" onsubmit="notasController.calculaNota(event)">
                <div class="campo-nota">
                    ...
                    <input id="peso-nota1" class="peso form-control" type="number" value="4" min="1" max="10">
                ...
                <div class="campo-nota">
                    ...
                    <input id="peso-nota2" class="peso form-control" type="number" value="6" min=1" max="10">
